...
namespace UnrealBuildTool
{
	...
	class CodeLiteGenerator : ProjectFileGenerator
	{
		...
		private readonly CodeliteProjectFileFormat ProjectFileFormat = CodeliteProjectFileFormat.CodeLite10;
		...
		protected override bool WriteMasterProjectFile(ProjectFile UBTProject, PlatformProjectGeneratorCollection PlatformProjectGenerators)
		{
			...
			CodeLiteWorkspace.Add(new XAttribute("Name", MasterProjectName)); // CodeLiteWorkspaceName
			CodeLiteWorkspace.Add(new XAttribute("SWTLW", "Yes"));            // CodeLiteWorkspaceSWTLW
			...
			foreach (ProjectFile CurProject in AllProjectFiles)
			{
				...
				foreach (ProjectTarget CurrentTarget in CurProject.ProjectTargets)
				{
					...
					CodeLiteWorkspaceProject.Add(new XAttribute("Name", ProjectName));           // CodeLiteWorkspaceProjectName
					CodeLiteWorkspaceProject.Add(new XAttribute("Path", ProjectTargetFileName)); // CodeLiteWorkspaceProjectPath
					CodeLiteWorkspaceProject.Add(new XAttribute("Active", "No"));                // CodeLiteWorkspaceProjectActive
